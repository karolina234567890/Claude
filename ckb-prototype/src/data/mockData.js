    ...
    sources: [
      {
        ...
        fact: 'Digital video consumption grew 34% YoY across key markets, with short-form content driving the highest engagement rates among 18–44 demographics.',
      ...
      },
      {
        ...
        fact: 'Pinterest and YouTube are the top-performing platforms for household product categories in the US, with Pinterest showing 2.4x higher purchase intent than the category average.',
        storage: 'SharePoint (external, read-only)',
        external: true,
      },
      {
        ...
        fact: 'Primary target: homeowners aged 25–55, HHI $50K+, skewing female 60/40, who prioritize cleanliness and home pride.',
        storage: 'CKB',
      ...
      },
      {
        ...
        fact: 'Soft Scrub Gel skews younger female 25–44 who prefer gel-format products and are active on Pinterest and Instagram.',
        storage: 'CKB',
        file: 'Manual input',
        external: false,
      },
